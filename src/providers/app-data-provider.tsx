...
export const AppDataProvider = ({
  ...
  const systemValue = useMemo(() => {
    const calculateSystemProxyAddress = () => {
      ...
      // This value describes the service the app currently provides. OS proxy settings can
      // retain an old address while disabled, so they must not override the live core port.
      return resolveProxyServiceAddress(verge.proxy_host, displayedMixedPort)
    }
