...
export interface TranslationResources {
  translation: {
      ...
      components: {
        ...
        currentProxy: {
          ...
          labels: {
            ...
            autoLogAlertThreshold: string
            autoLogAlertThresholdUnit: string
            autoMode: string
            directMode: string
            globalMode: string
            group: string
    ...
    proxies: {
      ...
      feedback: {
        notifications: {
          chainDisconnectedForGroupChange: string
          provider: {
            allUpdated: string
            genericError: string
            none: string
    ...
    traffic: {
      page: {
        consumers: {
          ...
          groupHost: string
          groupProcess: string
          historyDownloadTotal: string
          historyHint: string
          historyUploadTotal: string
          loadMore: string
          noMatch: string
          pause: string
          paused: string
