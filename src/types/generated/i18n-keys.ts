...
export const translationKeys = [
  ...
  'home.page.tooltips.openPortSettings',
  'home.page.tooltips.settings',
  'home.page.tooltips.updateSubscriptions',
  'home.page.tooltips.updateSubscriptionsEmpty',
  'home.page.actions.updateSubscriptions',
  'home.page.feedback.notifications.subscriptionsUpdated',
  'home.page.feedback.notifications.subscriptionsPartial',
  'home.page.feedback.notifications.noRemoteSubscriptions',
  'home.page.proxyServiceAddress',
  'home.page.cards.trafficStats',
  'home.page.cards.networkSettings',
  'home.page.cards.proxyMode',
  'home.page.cards.networkMode',
  'home.page.cards.overview',
  ...
  'home.page.settings.orderHint',
  'home.page.settings.emptyHidden',
  'home.page.settings.restoreOrder',
  'home.page.settings.tooltips.moveUp',
  'home.page.settings.tooltips.moveDown',
  ...
  'home.components.proxyTun.tooltips.dnsOverwrite',
  'home.components.proxyTun.labels.remoteDns',
  ...
  'home.components.systemInfo.sections.clash',
  'home.components.systemInfo.sections.system',
  'home.components.systemInfo.sections.network',
  ...
  'home.components.currentProxy.labels.noSubscriptionNodes',
  'home.components.currentProxy.labels.subscription',
  'home.components.currentProxy.labels.allSubscriptions',
  'home.components.currentProxy.labels.autoMode',
  'home.components.currentProxy.labels.autoLogAlertThreshold',
  'home.components.currentProxy.labels.autoLogAlertThresholdUnit',
  'home.components.currentProxy.labels.policyGroups',
  'home.components.currentProxy.labels.otherNodes',
  'home.components.currentProxy.labels.allNodes',
  'home.components.currentProxy.labels.nodeGroup',
  'home.components.currentProxy.tooltips.showIp',
  'home.components.currentProxy.tooltips.hideIp',
  'home.components.currentProxy.tooltips.copyIp',
  'home.components.currentProxy.tooltips.toggleIp',
  'home.components.currentProxy.tooltips.autoMode',
  'home.components.currentProxy.tooltips.autoLogAlertThreshold',
  'home.components.currentProxy.tooltips.enableNode',
  'home.components.currentProxy.status.ipLoading',
  'home.components.currentProxy.status.ipUnavailable',
  ...
  'home.components.currentProxy.status.autoOn',
  'home.components.currentProxy.status.autoOff',
  ...
  'profiles.page.feedback.notifications.updateBusy',
  ...
  'profiles.components.badges.baseConfig',
  ...
  'proxies.page.rules.search',
  'proxies.page.labels.proxyCount',
  'proxies.page.labels.delayCheckReset',
  'proxies.page.labels.nodeCount',
  'proxies.page.groupTypes.Selector',
  'proxies.page.groupTypes.URLTest',
  'proxies.page.groupTypes.Fallback',
  'proxies.page.groupTypes.LoadBalance',
  'proxies.page.groupTypes.Relay',
  'proxies.page.groupTypes.Direct',
  'proxies.page.groupTypes.Reject',
  'proxies.page.groupTypes.Pass',
  ...
  'proxies.page.chain.picker.title',
  'proxies.page.chain.picker.search',
  'proxies.page.chain.picker.empty',
  'proxies.page.chain.picker.added',
  'proxies.page.chain.picker.addButton',
  'proxies.page.chain.otherNodes',
  ...
  'settings.sections.clash.form.fields.cursorIspSetup',
  ...
  'settings.sections.clash.form.tooltips.cursorIspSetup',
  ...
  'settings.modals.clashPort.fields.enableRandomPort',
  'settings.modals.clashPort.tooltips.enableRandomPort',
  ...
  'settings.modals.cursorIspSetup.title',
  'settings.modals.cursorIspSetup.fields.protocol',
  'settings.modals.cursorIspSetup.fields.server',
  'settings.modals.cursorIspSetup.fields.port',
  'settings.modals.cursorIspSetup.fields.username',
  'settings.modals.cursorIspSetup.fields.password',
  'settings.modals.cursorIspSetup.fields.hopGroup',
  'settings.modals.cursorIspSetup.fields.exitGroup',
  'settings.modals.cursorIspSetup.fields.nodeName',
  'settings.modals.cursorIspSetup.toggles.applyAll',
  'settings.modals.cursorIspSetup.toggles.systemProxy',
  'settings.modals.cursorIspSetup.toggles.tunMode',
  'settings.modals.cursorIspSetup.toggles.globalChain',
  'settings.modals.cursorIspSetup.actions.apply',
  'settings.modals.cursorIspSetup.actions.test',
  'settings.modals.cursorIspSetup.actions.revert',
  'settings.modals.cursorIspSetup.messages.intro',
  'settings.modals.cursorIspSetup.messages.hopHint',
  'settings.modals.cursorIspSetup.messages.targets',
  'settings.modals.cursorIspSetup.messages.applied',
  'settings.modals.cursorIspSetup.messages.reverted',
  'settings.modals.cursorIspSetup.messages.applySuccess',
  'settings.modals.cursorIspSetup.messages.revertSuccess',
  'settings.modals.cursorIspSetup.messages.testOk',
  'settings.modals.cursorIspSetup.messages.globalChainWarn',
  'settings.modals.cursorIspSetup.messages.tunHint',
  'settings.modals.cursorIspSetup.errors.server',
  'settings.modals.cursorIspSetup.errors.port',
  'settings.modals.cursorIspSetup.errors.hopGroup',
  'settings.modals.cursorIspSetup.errors.exitGroup',
  'settings.modals.cursorIspSetup.errors.nodeName',
  'settings.modals.cursorIspSetup.errors.noProfiles',
  'settings.modals.cursorIspSetup.errors.missingHopNode',
  'settings.modals.cursorIspSetup.errors.testFailed',
  ...
  'traffic.page.title',
  'traffic.page.hero.download',
  'traffic.page.hero.upload',
  'traffic.page.hero.connections',
  'traffic.page.hero.memory',
  'traffic.page.metrics.uploadSpeed',
  'traffic.page.metrics.downloadSpeed',
  'traffic.page.metrics.todayUpload',
  'traffic.page.metrics.todayDownload',
  'traffic.page.metrics.uploadTotal',
  'traffic.page.metrics.downloadTotal',
  'traffic.page.metrics.memoryUsage',
  'traffic.page.metrics.activeConnections',
  'traffic.page.metrics.sessionTotal',
  'traffic.page.graph.title',
  'traffic.page.graph.hint',
  'traffic.page.consumers.title',
  'traffic.page.consumers.subtitle',
  'traffic.page.consumers.groupProcess',
  'traffic.page.consumers.groupHost',
  'traffic.page.consumers.groupConnection',
  'traffic.page.consumers.columnTarget',
  'traffic.page.consumers.columnChain',
  'traffic.page.consumers.columnUpload',
  'traffic.page.consumers.columnDownload',
  'traffic.page.consumers.columnSpeed',
  'traffic.page.consumers.empty',
  'traffic.page.consumers.connectionCount',
  'traffic.page.consumers.unknownProcess',
  'traffic.page.consumers.unknownHost',
  'traffic.page.consumers.search',
  'traffic.page.consumers.pause',
  'traffic.page.consumers.resume',
  'traffic.page.consumers.paused',
  'traffic.page.consumers.showing',
  'traffic.page.consumers.loadMore',
  'traffic.page.consumers.noMatch',
  'traffic.page.consumers.detail.chains',
  'traffic.page.consumers.detail.source',
  'traffic.page.consumers.detail.destination',
  'traffic.page.consumers.detail.process',
  'traffic.page.consumers.detail.type',
  'traffic.page.consumers.detail.rule',
  'traffic.page.consumers.detail.startTime',
  'traffic.page.consumers.detail.duration',
  'traffic.page.consumers.detail.connections',
  'traffic.page.consumers.detail.truncated',
  'traffic.page.consumers.subtitleHistory',
  'traffic.page.consumers.viewRealtime',
  'traffic.page.consumers.viewHistory',
  'traffic.page.consumers.rangeToday',
  'traffic.page.consumers.rangeLast3',
  'traffic.page.consumers.rangeLast7',
  'traffic.page.consumers.rangeLast30',
  'traffic.page.consumers.rangeAll',
  'traffic.page.consumers.clearHistory',
  'traffic.page.consumers.clearHistoryConfirm',
  'traffic.page.consumers.historyDownloadTotal',
  'traffic.page.consumers.historyUploadTotal',
  'traffic.page.consumers.historyHint',
  'traffic.page.consumers.emptyHistory',
] as const
