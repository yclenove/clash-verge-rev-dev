...
interface IClashLog {
  enable: boolean
  /** Page-only pause for the Logs stream; does not stop background alert monitoring. */
...
interface IVergeConfig {
  ...
  home_cards_order?: string[]
  enable_hover_jump_navigator?: boolean
  hover_jump_navigator_delay?: number
  enable_external_controller?: boolean
  /** 持久化的链式代理节点列表 */
  proxy_chain_nodes?: unknown[] | null
  /** 链式代理目标代理组 */
  proxy_chain_group?: string | null
}
