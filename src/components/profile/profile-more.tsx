...
export const ProfileMore = (props: Props) => {
  ...
  const globalTitles: Record<Props['id'], string> = {
    ...
    Rules: 'profiles.components.more.global.rules',
  }
  ...
  const chipLabels: Record<Props['id'], string> = {
    ...
    Rules: 'profiles.components.more.chips.rules',
  }
    ...
    <>
      ...
      {fileOpen && (
        <EditorViewer
          ...
          language={id === 'Script' ? 'javascript' : 'yaml'}
          path={`profile-more:${id}.${id === 'Script' ? 'js' : 'yaml'}`}
