...
import { resolveProxyServiceAddress } from '@/utils/mixed-port'
...
export const SysproxyViewer = forwardRef<DialogRef>((props, ref) => {
  ...
  const getSystemProxyAddress = useMemo(() => {
    return resolveProxyServiceAddress(value.proxy_host, displayedMixedPort)
  }, [value.proxy_host, displayedMixedPort])
